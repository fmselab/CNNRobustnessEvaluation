...
for step in Functions.frange(-180, 180, 9):
    ...
    for imagePath in imagePaths:
        ...
        try:
            ...
            # Rotate the image
            image = Functions.rotate_image(image, step)
            image = Functions.crop_around_center(image, *Functions.largest_rotated_rect(50, 50, math.radians(step)))
...
#plt.title("Accuracy")
#plt.xlabel("Image alteration - Rotation")
plt.ylabel("Accuracy")
plt.savefig("accuracy_plot_rotation.jpg")
