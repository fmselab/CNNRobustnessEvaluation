...
for step in Functions.frange(100, 200, 2.5):
    ...
    for imagePath in imagePaths:
        ...
        image = scipy.misc.imresize(image, float(1+((step-100)/100)))
...
#plt.title("Accuracy")
#plt.xlabel("Image alteration - Zoom")
plt.ylabel("Accuracy")
plt.savefig("accuracy_plot_zoom.jpg")
