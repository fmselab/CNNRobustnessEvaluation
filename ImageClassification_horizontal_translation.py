...
#plt.title("Accuracy")
#plt.xlabel("Image alteration - Horizontal translation")
plt.ylabel("Accuracy")
plt.savefig("accuracy_plot_horizontal_translation.jpg")
